...
/* Optional: pin the TRIGGER's BLE MAC for faster reconnects. Leave this
 * undefined (commented out) to use name-based discovery ("Trigger 4 Plus")
 * on every connect. Format: 6 hex bytes high-to-low.
