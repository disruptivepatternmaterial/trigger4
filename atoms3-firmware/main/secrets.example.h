 ...
 *                        Capture your own unit's value before use.
 *
...
#define TRIGGER_DEVICE_ID   0x00  /* replace with your unit's device ID */
#define TRIGGER_PASSWORD    0     /* replace with your decimal PIN */
